...
object Fun{
   ...
   def go_back_button(page: Var[Option[String]], language : Observable[Translation]) (implicit ctx:Ctx.Owner)=
     button(
       id := "go_back_button",
  ...
  def fun(page: Var[Option[String]], language : Observable[Translation]) (implicit ctx:Ctx.Owner) = div(justifyContent.center, alignItems.center,fontSize := "25px",
