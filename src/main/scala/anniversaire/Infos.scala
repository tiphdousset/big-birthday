...
Tout d'abord la date : les festivités se dérouleront du Samedi 8 au Lundi 10 Juin. Vous êtes attendus en fin d'après midi le Samedi (disons vers 17h) et nous quitterons les lieux le Lundi en fin de matinée. 

Pour le lieu, nous pouvons vous dire que ça se passe dans la magnifique bourgade de St Colomban (44), à 30 min au Sud de Nantes. La localisation précise du site vous sera communiquée d'ici là. 
...
Pour le couchage, un champ sera mis à disposition pour planter les tentes.  Pensez donc à prendre votre tente ;)
